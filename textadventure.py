...
def gamePlay():
 ...
 ## Movement function contains a while loop that runs through each of the possible choices. 
 ## If one of the excepted choices is not given at the specified location, the function breaks out of the loop and the program terminates.   
def movement(currentLocation,choice):
 ...
 ## win the game in this room by typing "solve", then "poison"
 ## use toilet by typing "use"  
def bathRoom():
  currentLocation = 1 
...
## typing "move" will go to moveBody()
def bedRoom():
  currentLocation = 3 
...
def moveBody(currentLocation):
  choice=requestString("""When you move the body, it lets out a long breathy sigh. 
  You jump back initially but realize it is just air escaping the body. 
  There are no other signs of foul play on this body.""")
...
## Function help accepts currentLocation, 
## which means that anywhere in the game, 
## you can display the following message       
